          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 1, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: isMobile ? 22 : 36 }}>
              ...
              <div>
                ...
                <Link href="/skicka" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#92ff63', color: '#0a0a0a', padding: '12px 22px', borderRadius: 10, fontSize: '0.85rem', fontWeight: 700, textDecoration: 'none' }}>
