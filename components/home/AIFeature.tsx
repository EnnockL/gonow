        ...
        <div style={{ position: 'relative' }}>
          <div
            style={{
              ...
              height: 300,
              borderRadius: '50%',
              background: 'rgba(74,222,85,0.28)',
              filter: 'blur(60px)',
              pointerEvents: 'none',
            }}
          />
            ...
            >
              <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3, paddingTop: 3, flexShrink: 0 }}>
                  <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#4ADE55', border: '2px solid var(--text)' }} />
                  <div style={{ width: 1.5, height: 26, background: 'rgba(74,222,85,0.5)' }} />
            ...
            >
              <div
                style={{
                  ...
                  height: 36,
                  borderRadius: '50%',
                  background: 'linear-gradient(135deg,#4ADE55,#34C759)',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  fontSize: '0.9rem',
