  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
      ...
      <div style={{
        ...
        {messages.map((m, i) => (
          <div key={i} style={{ display: 'flex', justifyContent: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
            {m.role === 'assistant' && (
              <div style={{ width: 24, height: 24, borderRadius: 7, background: 'rgba(74,222,85,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginRight: 8, alignSelf: 'flex-end' }}>
                <Zap size={11} style={{ color: '#4ADE55' }} />
              </div>
            )}
            <div style={{
              maxWidth: '78%',
              ...
              lineHeight: 1.6,
              whiteSpace: 'pre-wrap',
              background: m.role === 'user' ? '#4ADE55' : 'rgba(255,255,255,0.1)',
        ...
        {loading && (
          <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
            <div style={{ width: 24, height: 24, borderRadius: 7, background: 'rgba(74,222,85,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginRight: 8 }}>
              <Zap size={11} style={{ color: '#4ADE55' }} />
            </div>
          ...
          {SUGGESTIONS.map((s) => (
            <button
              ...
              onMouseEnter={(e) => {
                ...
                el.style.color = '#4ADE55'
                el.style.borderColor = 'rgba(74,222,85,0.35)'
                el.style.background = 'rgba(74,222,85,0.08)'
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget as HTMLElement
      ...
      <div style={{
        ...
        onFocusCapture={(e) => { (e.currentTarget as HTMLElement).style.borderColor = '#4ADE55' }}
      ...
      >
        ...
        <button
          ...
          title="Bifoga bild"
          onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.color = '#4ADE55' }}
        ...
        <button
          ...
          style={{
            ...
            background: input.trim() ? '#4ADE55' : 'rgba(255,255,255,0.08)',
