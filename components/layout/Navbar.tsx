...
const DARK_VARS: Record<string, string> = {
  ...
  '--accent': '#4ADE55', '--accent-dark': '#c8ffb3', '--secondary': '#4ADE55',
  '--secondary-strong': '#c8ffb3', '--secondary-soft': 'rgba(74,222,85,0.16)',
  '--secondary-softer': 'rgba(74,222,85,0.1)', '--accent-soft': 'rgba(74,222,85,0.18)',
  '--accent-softer': 'rgba(74,222,85,0.1)',
  '--page-gradient': 'linear-gradient(180deg,#0a0a0a 0%,#111111 100%)',
  '--hero-glow': 'radial-gradient(ellipse 80% 60% at 60% 20%,rgba(74,222,85,0.18) 0%,transparent 70%)',
  '--section-glow': 'radial-gradient(ellipse 60% 50% at 50% 100%,rgba(74,222,85,0.12) 0%,transparent 70%)',
  '--dot-color': 'rgba(74,222,85,0.08)',
  ...
  '--footer-border': 'rgba(74,222,85,0.16)', '--footer-divider': 'rgba(74,222,85,0.12)',
  '--footer-panel-bg': 'linear-gradient(180deg,rgba(74,222,85,0.12) 0%,rgba(74,222,85,0.05) 100%)',
  '--footer-chip-bg': 'rgba(255,255,255,0.06)', '--footer-chip-hover': 'rgba(74,222,85,0.12)',
  '--footer-input-bg': 'rgba(255,255,255,0.08)', '--footer-kicker': '#c8ffb3',
  '--enterprise-panel-bg': 'linear-gradient(135deg,rgba(18,22,29,0.96) 0%,rgba(28,33,42,0.98) 55%,rgba(74,222,85,0.16) 100%)',
  '--enterprise-panel-border': 'rgba(74,222,85,0.16)', '--enterprise-panel-chip-bg': 'rgba(255,255,255,0.08)',
  '--enterprise-panel-header-bg': 'linear-gradient(180deg,rgba(74,222,85,0.12) 0%,rgba(74,222,85,0.05) 100%)',
  '--enterprise-panel-soft-bg': 'linear-gradient(180deg,rgba(18,22,29,0.98) 0%,rgba(74,222,85,0.08) 100%)',
  '--enterprise-panel-glow': 'radial-gradient(circle,rgba(74,222,85,0.2) 0%,transparent 72%)',
  ...
  '--service-card-border': 'rgba(74,222,85,0.18)', '--service-card-icon-bg': 'rgba(255,255,255,0.06)',
  '--service-card-tag-bg': 'rgba(255,255,255,0.06)',
  '--service-card-shadow': '0 18px 40px rgba(74,222,85,0.08)',
  '--service-card-shadow-hover': '0 24px 54px rgba(74,222,85,0.14)',
  '--stats-panel-bg': 'linear-gradient(135deg,rgba(17,22,30,0.98) 0%,rgba(27,33,42,0.98) 52%,rgba(36,43,54,0.98) 100%)',
  '--stats-panel-border': 'rgba(74,222,85,0.18)', '--stats-panel-divider': 'rgba(74,222,85,0.12)',
  '--stats-panel-shadow': '0 18px 44px rgba(74,222,85,0.08)',
}
      ...
      <div style={{
        ...
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0, textDecoration: 'none' }}>
          <div style={{
            ...
            background: '#0a0a0a',
            border: '1.5px solid rgba(74,222,85,0.45)',
            boxShadow: '0 0 14px rgba(74,222,85,0.15)',
