    ...
    <div style={{ position: 'fixed', bottom: 24, right: 24, zIndex: 9999, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 12, pointerEvents: 'none' }}>
        ...
        <div style={{
          ...
          {view === 'thread' && active ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: 9, flex: 1, minWidth: 0 }}>
              <div style={{ width: 30, height: 30, borderRadius: '50%', flexShrink: 0, background: 'linear-gradient(135deg, rgba(146,255,99,0.35), rgba(146,255,99,0.15))', border: '1.5px solid rgba(146,255,99,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.62rem', fontWeight: 800, color: '#15803d' }}>
          ...
          <div style={{ flex: 1, overflowY: 'auto' }}>
            {convs.length === 0 ? (
              <div style={{ padding: '32px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10, textAlign: 'center' }}>
                <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(146,255,99,0.15)', border: '1.5px solid rgba(146,255,99,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <MessageCircle size={22} style={{ color: '#92ff63' }} />
                </div>
                ...
                <a href="/profil?tab=carriers" onClick={() => setOpen(false)} style={{ marginTop: 6, padding: '9px 20px', borderRadius: 999, background: '#92ff63', color: '#0a0a0a', fontSize: '0.78rem', fontWeight: 700, textDecoration: 'none', display: 'inline-block' }}>
                  Utforska förare
                </a>
              </div>
            ) : convs.map(conv => {
              ...
              return (
                ...
                >
                  <div style={{ width: 38, height: 38, borderRadius: '50%', flexShrink: 0, background: 'linear-gradient(135deg, rgba(146,255,99,0.3), rgba(146,255,99,0.12))', border: '1.5px solid rgba(146,255,99,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.72rem', fontWeight: 800, color: '#15803d' }}>
                  ...
                  <div key={msg.id}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: isMe ? 'flex-end' : 'flex-start', gap: 2 }}>
                      ...
                      <div style={{
                        ...
                        background: isMe ? '#92ff63' : (isDark ? '#2a2a2a' : '#e4e6eb'),
            ...
            <div style={{ padding: '10px 12px', borderTop: `1px solid ${isDark ? 'rgba(255,255,255,0.07)' : 'rgba(0,0,0,0.07)'}`, display: 'flex', gap: 8, alignItems: 'flex-end', flexShrink: 0, background: isDark ? '#181818' : '#f7f7f7' }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: reply.trim() ? (sent ? 'rgba(34,197,94,0.15)' : '#92ff63') : (isDark ? '#222' : '#e5e7eb'),
      ...
      <button
        ...
        style={{
          ...
          background: '#92ff63', border: 'none',
          boxShadow: '0 4px 20px rgba(146,255,99,0.4)',
          cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
          position: 'relative', transition: 'transform 0.15s, box-shadow 0.15s',
          flexShrink: 0, pointerEvents: 'auto',
        }}
        onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = 'scale(1.08)'; (e.currentTarget as HTMLElement).style.boxShadow = '0 6px 24px rgba(146,255,99,0.5)' }}
        onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = 'scale(1)'; (e.currentTarget as HTMLElement).style.boxShadow = '0 4px 20px rgba(146,255,99,0.4)' }}
      >
        {open
